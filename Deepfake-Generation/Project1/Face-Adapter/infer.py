...
def infer(args):
    ...
    vae_ft_mse = AutoencoderKL.from_pretrained("/netscratch/amkhan/pretrained_models/sd-vae-ft-mse", cache_dir=args.cache_dir if args.use_cache else None, torch_dtype=weight_dtype, local_files_only=args.use_cache).to(device)
    pipe.vae = vae_ft_mse
